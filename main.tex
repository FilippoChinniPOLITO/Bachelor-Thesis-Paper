...
\linespread{1.2}\Large {\bfseries Hyperparameter Optimization in Depth: Compasion of Techniques, Particle Swarm Optimization and Application in Drone Vision}\\[1.5cm]
\linespread{1}
